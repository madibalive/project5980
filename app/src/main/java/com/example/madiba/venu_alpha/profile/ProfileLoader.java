...
public class ProfileLoader {
    ...
    public static Observable<List<ParseObject>> loadGallery(String id,int skip, Date date){
    ...
    public static Observable<List<ParseObject>> loadEvent(String id,int skip, Date date){
        return Observable.create(new Observable.OnSubscribe<List<ParseObject>>() {
            @Override
            public void call(Subscriber<? super List<ParseObject>> subscriber) {
    ...
    public static Observable<List<ParseObject>> unfollow(String id){
        return Observable.create(new Observable.OnSubscribe<List<ParseObject>>() {
            @Override
            public void call(Subscriber<? super List<ParseObject>> subscriber) {
