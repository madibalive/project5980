...
public class ContactActivity extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if (position == 0){
                return FollowFragment.newInstance(ParseUser.getCurrentUser().getObjectId(),true);
            }else if (position ==1){
                return FollowFragment.newInstance(ParseUser.getCurrentUser().getObjectId(),false);
            }else {
